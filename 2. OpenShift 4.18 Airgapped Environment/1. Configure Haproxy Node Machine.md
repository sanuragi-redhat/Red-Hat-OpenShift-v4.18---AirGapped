...
|dc1bhkms3.ocp4.example.com     |   192.168.1.200     |
 ...
 #### ✅ Configure Haproxy Server.
    ...
    backend k8s_api_backend
        mode tcp
        balance source
        server      dc1bhkboot.ocp4.example.com 192.168.1.197:6443 check
    ...
    backend ocp_machine_config_server_backend
        mode tcp
        balance source
        server      dc1bhkboot.ocp4.example.com 192.168.1.197:22623 check
    ...
    backend ocp_http_ingress_backend
        balance source
        mode tcp
        server      dc1bhkms1.ocp4.example.com 192.168.1.198:80 check
        server      dc1bhkms2.ocp4.example.com 192.168.1.199:80 check
        server      dc1bhkms3.ocp4.example.com 192.168.1.200:80 check
    ...
    backend ocp_https_ingress_backend
        mode tcp
        balance source
        server      dc1bhkms1.ocp4.example.com 192.168.1.198:443 check
        server      dc1bhkms2.ocp4.example.com 192.168.1.199:443 check
        server      dc1bhkms3.ocp4.example.com 192.168.1.200:443 check
