...
Configure DNS. 
 ...
 #### ✅ Creating Forward and Reverse Zones 
    ...
    $TTL 1D
    @       IN SOA  root.lab.example.com. bastion.lab.example.com. (
                                            0       ; serial
                                            1D      ; refresh
                                            1H      ; retry
                                            1W      ; expire
    ...
    @       IN      A       192.168.0.195
    bastion.lab.example.com.     IN      A       192.168.0.195
    ...
    *.apps.lab.example.com.         IN      A       192.168.0.194
    ...
    195     IN      PTR     bastion.lab.example.com.
 ...
 #### ✅ Getting nslookup domain.
    ...
    [root@dc1bhkreg ~]# dig bastion.lab.example.com. +short
    192.168.0.195

    [root@dc1bhkreg ~]# nslookup 192.168.0.195
    195.1.168.192.in-addr.arpa      name = content.lab.example.com.
    195.1.168.192.in-addr.arpa      name = bastion.lab.example.com.
...
Configure NTP. 
 ...
 #### ✅ Checking synchronize time.
    ...
    ===============================================================================
    ^? bastion.lab.example.c>     0   7    17    -     +0ns[   +0ns] +/-    0ns
